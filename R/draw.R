...
#' @name drawFeatures
#'
#' @param map a background \code{leaflet} or \code{mapview} map to be used for
#'   editing. If \code{NULL} a blank mapview canvas will be provided.
...
#' @param editorOptions \code{list} of options suitable for passing to either
#'   \code{leaflet.extras::addDrawToolbar} or \code{leafpm::addPmToolbar}.
